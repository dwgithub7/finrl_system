...
def extract_best_test_window():
    ...
    for target_date in dates:
        ...
        try:
            ...
            if len(X_minute) > 0:
                print(f"✅ 조건 충족! {target_date} → 샘플 수: {len(X_minute)}")
