...
class DualBranchLSTMTrainer:
    ...
    def save(self):
        ...
        torch.save(self.model.state_dict(), os.path.join(self.model_dir, "dualbranch_lstm_model.pth"))

    def load(self):
        self.model.load_state_dict(torch.load(os.path.join(self.model_dir, "dualbranch_lstm_model.pth"), map_location=self.device))
