...
def train_one_epoch(model, dataloader, optimizer, combined_loss_fn, device="cuda"):
    model.train()
...
if __name__ == "__main__":
    ...
    # Train one epoch
    avg_loss, avg_entry_loss, avg_direction_loss = train_one_epoch(model, dataloader, optimizer, combined_criterion, device)
