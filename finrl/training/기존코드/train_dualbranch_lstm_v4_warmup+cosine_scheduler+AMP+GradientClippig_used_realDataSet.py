...
class RealDualBranchDataset(Dataset):
    def __init__(self, data_dir):
        self.x_minute = np.load(os.path.join(data_dir, 'SOLUSDT_1m_finrl_20240101~20250426_X_minute.npy'))
        self.x_daily = np.load(os.path.join(data_dir, 'SOLUSDT_1m_finrl_20240101~20250426_X_daily.npy'))
        self.y_entry = np.load(os.path.join(data_dir, 'SOLUSDT_1m_finrl_20240101~20250426_y_entry.npy'))
        self.y_direction = np.load(os.path.join(data_dir, 'SOLUSDT_1m_finrl_20240101~20250426_y_direction.npy'))
