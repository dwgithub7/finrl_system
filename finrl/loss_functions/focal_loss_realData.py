...
if __name__ == "__main__":
    ...
    log_path = f"testlog/focal_loss_log_{timestamp}.txt"
    ...
    with open(log_path, "w") as f:
        for x_minute, x_daily, y_entry, y_direction in dataloader:
            ...
            entry_loss = entry_criterion(entry_preds, y_entry)
            direction_loss = direction_criterion(direction_preds, y_direction)

            log_text = f"Entry Loss: {entry_loss.item():.4f}, Direction Loss: {direction_loss.item():.4f}\n"
